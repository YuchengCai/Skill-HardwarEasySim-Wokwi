...
# Arduino Wokwi Simulation Skill (v0.4.6) — WorkBuddy Adapter
...
1. **生成** — 写 `.ino` 代码，查 `references/arduino/index.json`（中文名匹配）→ components.md → experience.json，生成 `diagram.json` + `wokwi.toml`
